      ...
      <div className="container about__container">
        ...
        <div>
          <div className="about__content">
            <p>
              I am a third-year student pursuing B.Tech in the field of Information Technology from Indian Institute of Information Technology Sonepat. <br /> <br /> I'm a tech enthusiast with great interest in Web Development, DSA, Competitive Programming and Open Source. I am always looking to explore exciting opportunities, research about innovative ideas, participate in various hackathons and Open-Source events. <br />
